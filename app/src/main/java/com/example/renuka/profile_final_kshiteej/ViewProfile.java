package com.example.renuka.profile_final_kshiteej;
...
public class ViewProfile extends AppCompatActivity {
    ...
    public String SERVER_URL = "http://192.168.43.249/webapp/ContactUs.php";
    String name;
    //TextView brand_name, generic_name, category, dosage_form, molecular_formula, uses;
    TextView aid, info;
    @Override
